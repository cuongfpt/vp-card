        ...
        if (isset($_POST['addnews'])) {
            ...
            if (empty($errors) == true) {
                if ($this->input->post('position') == 1)
                    move_uploaded_file($file_tmp, "public/uploads/adv/slider/" . $file_name);
               else if ($this->input->post('position') == 2)
                    move_uploaded_file($file_tmp, "public/uploads/adv/partner/" . $file_name);
               else if ($this->input->post('position') == 3)
                    move_uploaded_file($file_tmp, "public/uploads/adv/adv/" . $file_name);
            }
            $data = array(
