                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="displayName" id="displayName" value="<?php echo $info->displayName?>">
                                </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <label class="col-sm-2 control-label">Tin khuyến mãi:</label>

                                <div class="col-sm-3">
                                    <?php if ($info->issale ==1): ?>
                                        <input type="checkbox" name="issale" value="1" checked>
                                    <?php else: ?>
                                        <input type="checkbox" name="issale" value="0">
                                    <?php endif?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <label class="col-sm-2 control-label">Tin hướng dẫn:</label>

                                <div class="col-sm-3">
                                    <?php if ($info->isguide ==1): ?>
                                        <input type="checkbox" name="isguide" value="1" checked>
                                    <?php else: ?>
                                        <input type="checkbox" name="isguide" value="0">
                                    <?php endif?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <label class="col-sm-2 control-label">Hiển thị footer:</label>

                                <div class="col-sm-3">
                                    <?php if ($info->isfooter ==1): ?>
                                        <input type="checkbox" name="isfooter" value="1" checked>
                                    <?php else: ?>
                                        <input type="checkbox" name="isfooter" value="0">
                                    <?php endif?>
                                </div>
                            </div>
                        </div>
