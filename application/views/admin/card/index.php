                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <?php foreach ($list as $row): ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo admin_url('card/edit/' . $row->id) ?>">
                                                <img src="<?php echo public_url('admin') ?>/images/edit.png"/>
                                            </a>
                                            <a class="verify_action" id="del_<?php echo $row->id?>" href="<?php echo admin_url('card/delete/' . $row->id) ?>">
